...
export default function BrandPage({ params }: BrandPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-black">
      ...
      <section className="bg-gradient-to-br from-black via-zinc-900 to-red-900/60 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div id="sell-form">
              <Suspense fallback={<div className="rounded-2xl p-8 border border-zinc-800 bg-zinc-900/30 animate-pulse h-96"></div>}>
                <CarSellForm />
              </Suspense>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={vehicle.model} className="text-center p-6 rounded-xl border border-zinc-800 bg-zinc-900/40 hover:bg-zinc-900/60 transition-all duration-300">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-red-900/30 flex items-center justify-center">
                  <span className="text-red-300 font-bold text-xl">{vehicle.model.charAt(0)}</span>
                </div>
      ...
      <section className="py-16 bg-gradient-to-b from-black via-zinc-950 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl border border-zinc-800 bg-zinc-900/40">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-red-900/30 flex items-center justify-center">
                <span className="text-red-300 text-2xl font-bold">$</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Best Prices</h3>
              <p className="text-zinc-300">We use real-time market data to ensure you get the best price for your {titleBrand}.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl border border-zinc-800 bg-zinc-900/40">
              ...
              <p className="text-zinc-300">Get your quote in 30 minutes and receive payment the same day.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl border border-zinc-800 bg-zinc-900/40">
              ...
              <p className="text-zinc-300">We buy {titleBrand}s in any condition — running, damaged, or not running.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-red-900/60 via-zinc-900 to-black">
