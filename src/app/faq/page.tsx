    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #FFF9E6 100%)' }}>
      ...
      <section className="py-12" style={{ backgroundColor: '#FFF9E6' }}>
        ...
        <div className="px-4 sm:px-8 max-w-4xl mx-auto text-center">
          ...
          {/* Contact CTA */}
          <div className="mt-16 bg-gradient-to-r from-blue-500/60 via-blue-300
 to-white border border-blue-200/30 rounded-xl p-8 text-gray-800 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="/contact" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors">Contact Us</a>
            </div>
          </div>
        </div>
      </section>
