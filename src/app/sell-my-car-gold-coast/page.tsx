...
export const metadata: Metadata = {
  title: "Sell My Car Gold Coast - AutoSell.ai | Get Cash for Your Car on the Gold Coast",
  description: "Sell your car fast on the Gold Coast with AutoSell.ai. We buy all cars on the Gold Coast and surrounding areas. Get instant quotes and same-day payment. Free pickup service.",
