...
export const metadata: Metadata = {
  title: "Sell My Used Car - AutoSell.ai | Get Cash for Your Used Vehicle",
  description: "Sell your used car fast with AutoSell.ai. We buy all used cars in any condition. Get instant quotes and same-day payment for your used vehicle.",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose AutoSell.ai for Your Used Car?
            </h2>
            <p className="text-xl text-gray-600">
