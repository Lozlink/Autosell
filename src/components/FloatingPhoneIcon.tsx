      ...
      {isVisible && (
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-blue-600 hover:bg-blue-600 text-gray-800 p-2.5 md:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
