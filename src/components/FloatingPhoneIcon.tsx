      ...
      {isVisible && (
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-[#FFC325] hover:bg-[#e6af1f] text-white p-2.5 md:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
